...
<body>
    ...
    <ul>
        ...
        <li><a href="#sair" onclick="showSection('sair')">Sair</a></li>
    </ul>
    ...
    <div id="cadastro_pro" class="section container">
        ...
        <form method="POST" enctype="multipart/form-data" class="row g-3">
            ...
            <div class="col-12">
                <button type="submit" name="btn_cadastrar"  class="btn">Cadastrar Produto</button>
            </div>
        </form>
    </div>
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4 mt-3">
            ...
            <div class="col">
                ...
                <div class="card-body">
                        ...
                        <p class="card-text text-success fw-bold">R$ <?php echo number_format($item['preco'], 2, ',', '.'); ?></p>
                    </div>
                    <div class="card-footer d-flex justify-content-between">
                        <button type="button" class="btn btn-primary btn-sm" onclick="showSection('editar_produto_<?php echo $item['cod_item']; ?>')">
    ...
    <form method="POST" enctype="multipart/form-data" class="row g-3">
        ...
        <div class="col-md-6">
            <label class="form-label">Preço</label>
            <input type="number" name="preco" step="0.01" class="form-control" value="<?php echo htmlspecialchars($item['preco']); ?>" required>
        </div>
        ...
        <div class="col-md-6">
            ...
            <img id="imgPreview" class="img-preview mt-2" src="imagens/<?php echo htmlspecialchars($item['imagem']); ?>" alt="Imagem atual do produto" style="max-width: 100px;">
        </div>

        <div class="col-md-6">
            <label class="form-label">Categoria</label>
            <select name="categoria" class="form-select">
                <option value="1" <?php echo ($item['fk_Categoria_cod_categoria'] == 1) ? 'selected' : ''; ?>>Categoria 1</option>
                <option value="2" <?php echo ($item['fk_Categoria_cod_categoria'] == 2) ? 'selected' : ''; ?>>Categoria 2</option>
            </select>
        </div>

        <div class="col-12">
            <button type="submit" name="btn_editar" class="btn btn-primary w-100">Salvar Alterações</button>
        </div>
    </form>
</div>
    <?php endwhile; ?>
